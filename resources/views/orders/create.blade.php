        ...
        <div class="card shadow-lg p-4">
            ...
            <form id="myForm" action="{{ route('orders.store') }}" method="POST">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" name="products[0][qty]"
                                        class="form-control qty @error('products.0.qty') is-invalid @enderror">
                                ...
                                <td>
                                    <input type="number" name="products[0][amount]"
                                        class="form-control amount @error('products.0.amount') is-invalid @enderror">
                                    @error('products.0.amount')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </td>
                                <td>
                                    <input type="text" name="products[0][total]" class="form-control total bg-light"
                                        readonly>
                                </td>
                ...
                <div class="text-end mt-2">
                    <button type="button" id="addRow" class="btn btn-success"><i class="bi bi-plus-circle"></i> Add
                        More</button>
                </div>
                ...
                <div class="text-center mt-4">
                    <button type="submit" class="btn btn-primary btn-lg"><i class="bi bi-check-circle"></i> Submit
                        Order</button>
                </div>
